...
metadata: {"clawdbot":{"emoji":"🧠","requires":{"bins":[]},"os":["linux","darwin","win32"],"configPaths":["brain/cognitive/"],"configPaths.optional":["./AGENTS.md","./SOUL.md","./HEARTBEAT.md"]}}
---
...
Memory lives in `brain/cognitive/` with tiered structure. If `brain/cognitive/` does not exist, run `setup.md`.
...
- Stores preferences in local files (`brain/cognitive/`)
- Maintains heartbeat state in `brain/cognitive/heartbeat-state.md` when the workspace integrates heartbeat
- Reads its own memory files on activation

This skill NEVER:
- Accesses calendar, email, or contacts
- Makes network requests
- Reads files outside `brain/cognitive/`
...
Local state lives in `brain/cognitive/`:
